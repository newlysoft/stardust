    ...
    return (
      <div>
        <Message className='info'>
          A Confirm is a pre-configured Modal.  You can use all props for a regular Modal.
        </Message>
        <ExampleSection title='Types'>
          ...
          <ComponentExample
            title='Callbacks'
            description='A confirm callsback onCancel and onConfirm'
        ...
        <ExampleSection title='Variations'>
          ...
          <ComponentExample
            title='Button Labels'
            description='A confirm can specify button labels'
